...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.account' => 'getApp_AccountService',
            'app.authentication' => 'getApp_AuthenticationService',
            'app.category' => 'getApp_CategoryService',
            'app.product' => 'getApp_ProductService',
            'app.session' => 'getApp_SessionService',
    ...
    /**
     * Gets the 'app.account' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\AccountService A AppBundle\Service\AccountService instance
     */
    protected function getApp_AccountService()
    {
        return $this->services['app.account'] = new \AppBundle\Service\AccountService($this->get('doctrine'));
    }

    /**
     * Gets the 'app.authentication' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\AuthenticationService A AppBundle\Service\AuthenticationService instance
     */
    protected function getApp_AuthenticationService()
    {
        return $this->services['app.authentication'] = new \AppBundle\Service\AuthenticationService($this->get('app.account'), $this->get('session'));
    }

    /**
     * Gets the 'app.category' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\CategoryService A AppBundle\Service\CategoryService instance
     */
    protected function getApp_CategoryService()
    {
        return $this->services['app.category'] = new \AppBundle\Service\CategoryService($this->get('doctrine'));
    }

    /**
     * Gets the 'app.product' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\ProductService A AppBundle\Service\ProductService instance
     */
    protected function getApp_ProductService()
    {
        return $this->services['app.product'] = new \AppBundle\Service\ProductService($this->get('doctrine'));
    }

    /**
     * Gets the 'app.session' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        return $this->services['app.session'] = new \AppBundle\Service\SessionService($this->get('session'));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('eVDYSA+wPg', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('W7J1krm5al', 0, 'mK3cm137M7FO2jSDZ9HVXj', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'postgres', 'user' => 'postgres', 'password' => 'password', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ca14d6aefdb5dcbb045a77021799ccd4280bb640cd44aea1beb66d44c2d04c34');
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('opZAvBnSTA', NULL, 'mK3cm137M7FO2jSDZ9HVXj', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ae8694789fb3ccfec951e4412feb8620f2268d41');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NtbNjoovAt', 0, 'mK3cm137M7FO2jSDZ9HVXj', (__DIR__.'/pools'), $this->get('monolog.logger.cache'));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58b888dc5cebb3.70660704')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'ae8694789fb3ccfec951e4412feb8620f2268d41',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'ae8694789fb3ccfec951e4412feb8620f2268d41',
